...
- use pyWinhook, a pyHook fork with some updates for support latest Visual Studio compilers. Two methods here:
    a) `pip install pyWinhook==1.6.2`
    b) `python -m pip install pyWinhook-1.6.2-cp38-cp38-win_amd64.whl`
